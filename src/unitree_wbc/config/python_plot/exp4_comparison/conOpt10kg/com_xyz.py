...
file_paths = ["xyz_wOpt_10kg.txt", "xyz_nOpt_10kg.txt"]  # Replace with the paths to your two files
data_list = []
...
plt.title("Err XYZ Comparison (Payload=10kg)", pad=40)  # Move the title down a little
plt.xlabel("Time (s)")
plt.ylabel("Err (m)")
...
plt.savefig("exp4-xyz-compare-10kg.png", dpi=1000)
plt.show()
