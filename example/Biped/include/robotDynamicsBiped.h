...
/**
 * @file RobotDynamicsBiped.h
 * @brief declaration of the RobotDynamicsBiped class, a subclass of the abstract class RobotDynamics
...
private:
    ...
    unsigned int idPelvis, idTorso, idLeftSole, idRightSole;
